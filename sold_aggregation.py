...
# Week 1 Sold Data Audit:
# - Sum of individual files: 615,725
# - Rows after combining: 615,725
...
print("Processing sold datasets...")

# find all monthly sold files
file_list = sorted(glob.glob(os.path.join(DATA_DIR, "CRMLSSold*.csv")))

if not file_list:
    print("Error: No sold files found.")
    exit()
...
# save to root folder
output_path = r"C:\GitHub\IDX-Exchange-MLS-Analytics\sold.csv"
filtered_df.to_csv(output_path, index=False)
print(f"\nSaved master sold file to: {output_path}")
